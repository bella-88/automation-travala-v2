...
import static interfaces.hotel.NFT.BuyNFTPageUI.*;

public class BuyNFTPage extends CommonHotelPages {
  WebDriver driver;
  boolean status;
  boolean check = true;
  ...
  public BuyNFTPage(WebDriver driver_) {
    this.driver = driver_;
...
//  selectDropDownByText(driver,AMOUNT_NFT_DROPDOWN,AMOUNT_NFT_LIST_DYNAMIC,"3 NFT" );
  ...
  public MyNFTPage clickToViewTransaction() {
    clickToElementByJavascript(driver, NFT_POP_UP_VIEW_TRANSACTION_BTN);
    return new MyNFTPage(driver);
  }
}
