...
public static final int HIGHLIGHT_ELEMENT_TIMEOUT_FOR_DEMO = 100;
  ...
  //FILTER
  public static final String FREE_BREAKFAST_EXPECT_TEXT = "Breakfast Included";
  public static final String REFUNDABLE_EXPECT_TEXT = "Refundable";
