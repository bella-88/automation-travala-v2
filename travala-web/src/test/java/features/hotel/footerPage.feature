...
#    And I click on AVA token link and verify displayed text on this page
  ...
  Scenario: Verify NAVIGATE and CONTENT on the pages at SUPPORT
  ...
  Scenario: Verify NAVIGATE and CONTENT on the pages at USEFUL LINKS
  ...
  Scenario: Verify NAVIGATE and CONTENT on the pages at RESOURCES
  ...
  Scenario: Verify navigate to page of COMMUNITY when click on link at footer part
    ...
    #========================VERIFY CONTENT OF CONCIERGE PAGE=======================
@Concierge
  Scenario: Verify content of Concierge page
...
#    And I verify travel inspiration options
#    And I verify contact us of concierge page

#========================VERIFY CONTENT OF HELP PAGE=======================

  Scenario: Verify displayed content HELP PAGE
...
#    And I click on contact and verify displayed text on this page
  ...
  @TRAVO-16083
  Scenario: Verify landing page for US TRAVO-16083
    And I click on Binance Travel link and verify displayed text on this page
#    And I click on Business Travel link and verify displayed text on this page
#    And I click on Careers link and verify displayed text on this page
#    And I click on Coin listing link and verify displayed text on this page
